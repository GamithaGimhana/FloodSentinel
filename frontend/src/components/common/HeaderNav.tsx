import { ShieldAlert, PhoneCall, Map, AlertTriangle, Navigation, Bell, Activity } from "lucide-react";

export type NavTab = "map" | "alerts" | "districts" | "tracker" | "register";
  ...
  return (
    <header className="app-header">
      ...
      <nav className="header-nav-tabs" aria-label="Main Navigation">
        ...
        >
          <Activity size={16} />
          <span>Risk Gauge & Simulator</span>
        </button>
